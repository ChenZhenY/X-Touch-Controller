...
public final class multidim_array_t implements lcm.lcm.LCMEncodable
{
    public int size_a;
    public int size_b;
    public int size_c;
    ...
    {
        if (classes.contains(lcmtest.multidim_array_t.class))
            return 0L;
 
        classes.add(lcmtest.multidim_array_t.class);
    ...
    public multidim_array_t(byte[] data) throws IOException
    {
        this(new LCMDataInputStream(data));
    }
 
    public multidim_array_t(DataInput ins) throws IOException
    {
    ...
    public static lcmtest.multidim_array_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        lcmtest.multidim_array_t o = new lcmtest.multidim_array_t();
    ...
    public lcmtest.multidim_array_t copy()
    {
        lcmtest.multidim_array_t outobj = new lcmtest.multidim_array_t();
